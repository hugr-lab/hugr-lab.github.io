...
- **LLM (AI Models)**: Connect to AI model providers (OpenAI, Anthropic, Gemini) for text generation and tool calling. Accessed via the `core.models` runtime module (see [LLM](11-llm.md) and [AI Models Guide](/docs/ai-models)).
